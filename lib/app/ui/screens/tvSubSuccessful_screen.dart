...
class TvsubsuccessfulScreen extends StatefulWidget {
  const TvsubsuccessfulScreen({super.key});

  @override
  State<TvsubsuccessfulScreen> createState() => _TvsubsuccessfulScreenState();
}

class _TvsubsuccessfulScreenState extends State<TvsubsuccessfulScreen> {
  @override
                    ...
                    child: RichText(
                      ...
                      text: TextSpan(
                        ...
                        children: [
                          TextSpan(
                            text:
                                'Your Startimes 7 Days Subscription is successful! ',
                            style: w400_17_s(
                              context,
