...
import 'top_up_B_successful_screen.dart';

class TopUpBankAccountScreen extends StatefulWidget {
  final String bankCardDetails;
  const TopUpBankAccountScreen({super.key, required this.bankCardDetails});

  @override
  State<TopUpBankAccountScreen> createState() => _TopUpBankAccountScreenState();
}

class _TopUpBankAccountScreenState extends State<TopUpBankAccountScreen> {
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      Container(
                        child: svgAsset('lib/assets/top_up_Ccard.svg'),
                      ),
                      Padding(
                        padding: const EdgeInsets.only(left: 8.0),
                        child: w500_17(
                          context,
                          widget.bankCardDetails,
                          blackColor,
                        ),
                      ),
                    ],
