...
import 'betting_share_screen.dart';
import 'bottomNavigation.dart';

class BettingSuccessfulScreen extends StatefulWidget {
  const BettingSuccessfulScreen({super.key});

  @override
  State<BettingSuccessfulScreen> createState() =>
      _BettingSuccessfulScreenState();
}

class _BettingSuccessfulScreenState extends State<BettingSuccessfulScreen> {
  @override
          ...
          children: [
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  w700_20(context, 'Payment Successful!', blackColor),
                ],
              ),
            ),
            Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                w400_14(context, '2000 NGN has been payment to 1xBET User',
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                w400_14(context, 'ID (8167-485-678)',
                    Color.fromRGBO(51, 51, 51, 0.7)),
              ],
            ),
            GestureDetector(
