...
class OnboardingScreen04 extends StatelessWidget {
  ...
  const OnboardingScreen04({super.key, required this.controller});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: whiteColor,
        leadingWidth: screenSize.width * 0.4, // Make leading width responsive
        leading: Padding(
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  w400_14(
                    context,
                    'Enjoy fast, smooth and secure payment on',
                    blackColor,
                  ),
                  w400_14(
                    context,
                    'EgoFinance with no internet hassles',
                    blackColor,
                  ),
                  SizedBox(height: screenSize.height * 0.01),
                ],
