...
class TopUpScreen02 extends StatefulWidget {
  const TopUpScreen02({super.key});

  @override
  State<TopUpScreen02> createState() => _TopUpScreen02State();
}

class _TopUpScreen02State extends State<TopUpScreen02> {
  bool isVisible = true;
          ...
          child: Visibility(
            ...
            child: Column(
              children: [
                Padding(
                  padding:
                      const EdgeInsets.only(left: 20, top: 30.0, bottom: 10),
                  child: Row(
                                  ...
                                  GestureDetector(
                                    ...
                                    child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                        borderRadius: BorderRadius.circular(10),
                                        color:
                                            Color.fromRGBO(4, 140, 252, 00.05),
                                      ),
                                      child: Row(
                                        mainAxisAlignment:
                                            MainAxisAlignment.spaceBetween,
...
// Custom TextInputFormatter for formatting in groups of 4
...
// Custom TextInputFormatter for the "MM/YY" format
class ExpirationDateFormatter extends TextInputFormatter {
  ...
  TextEditingValue formatEditUpdate(
    ...
    // Limit input to 4 characters (2 digits, "/", 2 digits)
    if (newText.length > 4) {
