...
class InternetSuccessfullScreen extends StatefulWidget {
  const InternetSuccessfullScreen({super.key});

  @override
  State<InternetSuccessfullScreen> createState() =>
      _InternetSuccessfullScreenState();
}

class _InternetSuccessfullScreenState extends State<InternetSuccessfullScreen> {
  @override
        ...
        child: ListView(
          children: [
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                w400_14(context, 'Subscription of 27.5GB Sucessful',
