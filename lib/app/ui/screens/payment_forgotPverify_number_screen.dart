...
class ForgotPasswordPaymentVerifyNumberScreen extends StatefulWidget {
  const ForgotPasswordPaymentVerifyNumberScreen({super.key});

  @override
  State<ForgotPasswordPaymentVerifyNumberScreen> createState() =>
      _ForgotPasswordPaymentVerifyNumberScreenState();
}

class _ForgotPasswordPaymentVerifyNumberScreenState
    extends State<ForgotPasswordPaymentVerifyNumberScreen> {
