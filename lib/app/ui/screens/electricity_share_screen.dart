...
class ElectricityShareScreen extends StatefulWidget {
  const ElectricityShareScreen({super.key});

  @override
  State<ElectricityShareScreen> createState() => _ElectricityShareScreenState();
}

class _ElectricityShareScreenState extends State<ElectricityShareScreen> {
  @override
