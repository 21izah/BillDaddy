...
import 'electricity_beneficiary_screen.dart';
import 'electricity_verification_screen.dart';
...
class _ElectricityScreenState extends State<ElectricityScreen> {
  ...
  List<Map<String, dynamic>> electricityCompanies = [
    {
      ...
      'imagePath': 'lib/assets/JOS_ELEC.png',
    },
    {
      'name': 'Kaduna Electricity',
      'imagePath': 'lib/assets/Kaduna.png',
    },
    {
      'name': 'Ikeja Disco',
      'imagePath': 'lib/assets/IkejaE.png',
    },
    {
      'name': 'Abuja Electricity',
      'imagePath': 'lib/assets/AbujaEle.png',
    },
    {
      'name': 'Port Harcourt',
      'imagePath': 'lib/assets/PhElec.png',
    },
    {
      'name': 'Eko Electricity',
      'imagePath': 'lib/assets/IBEDC.png',
    },
  ];
  ...
  void initState() {
    ...
    _meterNumberController.addListener(_updateButtonState);
  ...
  void dispose() {
    ...
    _meterNumberController.removeListener(_updateButtonState);
                  ...
                  children: [
                    ...
                    GestureDetector(
                      onTap: () {
                        Navigator.of(context).push(
                          PageTransition(
                            child: ElectricityVerificationScreen(),
                            type: PageTransitionType.leftToRight,
                            // duration: Duration(seconds: 1),
                          ),
                        );
                    ...
                    child: Column(
                      children: [
                        ...
                        Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            w400_14(context, 'Meter Number', blackColor),
                            Container(
                              padding: EdgeInsets.all(8),
                              decoration: BoxDecoration(
                                borderRadius: BorderRadius.circular(5),
              ...
              child: Row(
                children: [
                  ...
                  Padding(
                    ...
                    child: w600_17(context, 'Electricity', blackColor),
                  ),
                ],
              ),
            ),
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: TextFormField(
                      ...
                      validator: (value) =>
                          value!.isEmpty ? 'Meter Number is required' : null,
                      decoration: InputDecoration(
                        // contentPadding: EdgeInsets.only(
                        //   left: 15,
                        //   top: 20,
