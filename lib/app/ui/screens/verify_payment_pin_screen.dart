...
class VerifyPaymentPinScreen extends StatefulWidget {
  const VerifyPaymentPinScreen({super.key});

  @override
  State<VerifyPaymentPinScreen> createState() => _VerifyPaymentPinScreenState();
}

class _VerifyPaymentPinScreenState extends State<VerifyPaymentPinScreen> {
            ...
            child: GestureDetector(
              ...
              child: Row(
                children: [
                  GestureDetector(
                    onTap: () {
                      Get.offAllNamed('/paymentSettings');
                    },
                    child: Icon(
                  ...
                  Padding(
                    ...
                    child: w600_17(context, 'Verify Payment Pin', blackColor),
                  ),
                ],
              ),
            ),
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: w700_18(context, 'Current Payment Pin', blackColor),
              ),
              const SizedBox(
                height: 20,
              ),
              ...
              GestureDetector(
                onTap: () {
                  Get.toNamed('/paymentVerifyNumber');
                },
                child: Padding(
                  padding: EdgeInsets.only(
