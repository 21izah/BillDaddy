...
import 'giftcard_share_screen.dart';

class GiftcardSuccessfulScreen extends StatefulWidget {
  const GiftcardSuccessfulScreen({super.key});

  @override
  State<GiftcardSuccessfulScreen> createState() =>
      _GiftcardSuccessfulScreenState();
}

class _GiftcardSuccessfulScreenState extends State<GiftcardSuccessfulScreen> {
  @override
          ...
          children: [
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  w700_20(context, 'Order Successfully Initiated', blackColor),
                ],
              ),
            ),
            GestureDetector(
