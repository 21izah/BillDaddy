...
class WithdrawcardSuccessfulScreen extends StatefulWidget {
  const WithdrawcardSuccessfulScreen({super.key});

  @override
  State<WithdrawcardSuccessfulScreen> createState() =>
      _WithdrawcardSuccessfulScreenState();
}

class _WithdrawcardSuccessfulScreenState
    extends State<WithdrawcardSuccessfulScreen> {
  @override
      ...
      body: Padding(
        ...
        child: ListView(
          ...
          children: [
            ...
            GestureDetector(
              onTap: () {
                Get.toNamed('/me/withdrawReceipt');
              },
              child: Container(
