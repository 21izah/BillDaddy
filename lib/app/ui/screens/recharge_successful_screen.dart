...
import 'recharge_share_screen.dart';

class RechargeSuccessfulScreen extends StatefulWidget {
  const RechargeSuccessfulScreen({super.key});

  @override
  State<RechargeSuccessfulScreen> createState() =>
      _RechargeSuccessfulScreenState();
}

class _RechargeSuccessfulScreenState extends State<RechargeSuccessfulScreen> {
  @override
          ...
          children: [
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  w700_20(context, 'Recharge Successful!', blackColor),
                ],
              ),
            ),
            Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                w400_14(context, '100 NGN has been sent to ',
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                w400_14(context, '+2349056789045', blackColor),
              ],
            ),
            GestureDetector(
              onTap: () {
