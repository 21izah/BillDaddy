...
class ElectricitySuccessfulScreen extends StatefulWidget {
  const ElectricitySuccessfulScreen({super.key});

  @override
  State<ElectricitySuccessfulScreen> createState() =>
      _ElectricitySuccessfulScreenState();
}

class _ElectricitySuccessfulScreenState
    extends State<ElectricitySuccessfulScreen> {
  @override
          ...
          children: [
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  w700_20(context, 'Subscription Successful', blackColor),
                ],
              ),
            ),
            Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                w400_14(context, 'Your meter has been credited',
