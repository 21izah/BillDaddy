...
class OnboardingScreen03 extends StatelessWidget {
  ...
  OnboardingScreen03({super.key, required this.controller});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: whiteColor,
        leadingWidth: screenSize.width * 0.4, // Make it responsive
        leading: Padding(
          padding: EdgeInsets.only(left: screenSize.width * 0.05),
          child: GestureDetector(
            onTap: () {
              // Navigate to previous page if not the first one
