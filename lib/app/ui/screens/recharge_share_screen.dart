...
class RechargeShareScreen extends StatefulWidget {
  const RechargeShareScreen({super.key});

  @override
  State<RechargeShareScreen> createState() => _RechargeShareScreenState();
}

class _RechargeShareScreenState extends State<RechargeShareScreen> {
  @override
