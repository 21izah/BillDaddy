...
class DataSuccessfulScreen extends StatefulWidget {
  final String amount;
  const DataSuccessfulScreen({super.key, required this.amount});

  @override
  State<DataSuccessfulScreen> createState() => _DataSuccessfulScreenState();
}

class _DataSuccessfulScreenState extends State<DataSuccessfulScreen> {
  @override
          ...
          children: [
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  w400_16(context, 'Successful', blackColor),
                ],
              ),
            ),
            Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                w500_24(context, '${widget.amount}', secondaryColor),
              ],
            ),
            GestureDetector(
              onTap: () {
