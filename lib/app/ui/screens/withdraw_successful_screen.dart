...
class WithdrawSuccessfulScreen extends StatefulWidget {
  const WithdrawSuccessfulScreen({super.key});

  @override
  State<WithdrawSuccessfulScreen> createState() =>
      _WithdrawSuccessfulScreenState();
}

class _WithdrawSuccessfulScreenState extends State<WithdrawSuccessfulScreen> {
  @override
