...
class OnboardingScreen05 extends StatelessWidget {
  ...
  OnboardingScreen05({super.key, required this.controller});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: whiteColor,
        leadingWidth: screenSize.width * 0.4, // Responsive leading width
        leading: Padding(
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  w400_14(
                    context,
                    'Pay for other bills like TV Subscriptions,',
                    blackColor,
                  ),
                  w400_14(
                    context,
                    'Internet, electricity, giftcards.',
                    blackColor,
                  ),
                  SizedBox(height: screenSize.height * 0.01),
                ],
